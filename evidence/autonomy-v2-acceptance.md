...
| Legacy 2.0.19 migration | yes | PASS | deterministic fixture SHA-256 `B6E1FE06EBC4DA35376D0640249B13D1ED66D23353C3BAAC875A9518CBE88736`; AUT-P0-019 also verifies exact URL-only repository binding in migration v4 |
| Full existing suite | yes | PASS | 189 tests; `.venv\Scripts\python.exe -m pytest -q --tb=short` |

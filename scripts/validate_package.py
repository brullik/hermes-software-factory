...
REQUIRED = [
    ...
    "factory/recursive_improvement.py",
    "factory/support_bundle.py",
    ...
    "scripts/ready_result.py",
    "scripts/recursive_improvement_control.py",
    "scripts/support_bundle.py",
    "scripts/support_bundle_reconciler.py",
    "scripts/product_github_capability.py",
    "scripts/broker_epoch.py",
    ...
    "scripts/qualification/run-lts-ready.sh",
    ...
    "config/systemd/hermes-factory-product-github-broker.service",
    "config/systemd/hermes-factory-product-github-capability.service",
    "config/systemd/hermes-factory-product-github-capability.path",
    "config/systemd/hermes-factory-stable-provider-capability.service",
    "config/systemd/hermes-factory-stable-provider-capability.path",
    "config/systemd/hermes-factory-stable-runtime-attestation.service",
    "config/systemd/hermes-factory-ready-result.service",
    "config/systemd/hermes-factory-recursive-improvement.service",
    "config/systemd/hermes-factory-recursive-improvement.timer",
    "config/systemd/hermes-factory-support-bundle-reconciler.service",
    "config/systemd/hermes-factory-support-bundle-reconciler.timer",
    "config/systemd/hermes-factory-support-bundle@.service",
    "scripts/stable_provider_capability.py",
    "scripts/stable_runtime_attestation.py",
